    ...
    33679: function (a) {
      var i,
        ...
        r = (a, i) =>
          function () {
            return (
              i || (0, a[c(a)[0]])((i = {exports: {}}).exports, i), i.exports
            );
          },
        l = (a, i, e, n) => {
          if ((i && 'object' == typeof i) || 'function' == typeof i)
            for (let p of c(i))
              t.call(a, p) ||
                ...
                o(a, p, {
                  get: () => i[p],
                  enumerable: !(n = s(i, p)) || n.enumerable,
                });
          return a;
        },
        m = r({
        ...
        d = {};
      ((a, i) => {
        for (var e in i) o(a, e, {get: i[e], enumerable: !0});
      })(d, {
        PreviewController: () => k,
        getExtension: () => w,
        joinFilepath: () => h,
        ...
        (a.exports = l(o({}, '__esModule', {value: !0}), d));
      var x = '$CSB_RELAY',
        v =
          ((e = null != (i = u()) ? n(p(i)) : {}),
          l(
            i && i.__esModule ? e : o(e, 'default', {value: i, enumerable: !0}),
            i
          )),
        b = new Map();
      for (let [a, i] of Object.entries(v.default)) {
        let e = i.extensions;
        if (e?.length) for (let i of e) b.set(i, a);
      }
      var f = 0;
      function g(a) {
        let i = a.split('/').filter(Boolean),
          e = i.join('/');
        return '/' + e;
      }
      function h(a, i) {
      ...
      var k = class {
        ...
        async getIndexAtPath(a) {
          for (let i of this.indexFiles)
            try {
              let e = await this.getFileContent(h(a, i));
              return e;
            } catch (a) {}
          throw Error('No index file not found');
        }
        async handleWorkerRequest(a) {
          if (!this.initPromise) throw Error('Init promise is null');
          let [i, e] = await this.initPromise;
          try {
            let n = g(new URL(a.url, i).pathname),
              o = null,
              s = {};
            try {
              o = await this.getFileContent(n);
            } catch (a) {}
            if (
              (null == o &&
                ((o = await this.getIndexAtPath(n)),
        ...
        getRelayUrl(a) {
          let i = new URL(a);
          return (i.pathname = '/__csb_relay/'), i.toString();
        }
        async _initPreview() {
          let a = (function () {
              let a = Date.now(),
                i = (f += 1);
              return (+`${a}${Math.round(1e4 * Math.random())}${i}`).toString(
                16
              );
            })(),
            i = new URL(this.baseUrl);
          (i.hostname = a + '-' + i.hostname), (i.pathname = '/');
          let e = this.getRelayUrl(i.toString()),
          ...
          let o = new MessageChannel(),
            s = n.contentWindow;
          if (!s) throw Error('Could not get iframe contentWindow');
          return new Promise((a) => {
            let e = o.port1;
            (e.onmessage = (o) => {
              if ('object' == typeof o.data && o.data.$channel === x)
                switch (o.data.$type) {
                  case 'preview/ready':
                    a([i.toString(), e, n]);
                    break;
              ...
              (n.onload = () => {
                s.postMessage({$channel: x, $type: 'preview/init'}, '*', [
                  o.port2,
                ]);
              });
          });
        ...
        destroy() {
          if (this.initPromise) {
            let a = this.initPromise;
            a.then((a) => {
              a[1].close();
              let i = this.getRelayUrl(a[0]),
                e = document.body.querySelectorAll(`src="${i}"`);
