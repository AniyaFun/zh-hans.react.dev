    ...
    15932: function (e, t, r) {
      ...
      class X {
        ...
        push(e, t, r) {
          ...
          return (
            ({url: e, as: t} = D(this, e, t)), this.change('pushState', e, t, r)
          );
        }
        replace(e, t, r) {
          return (
        ...
        async change(e, t, r, n, a) {
          ...
          let k, U;
          if (!(0, R.isLocalURL)(t)) return G({url: t, router: this}), !1;
          let H = 1 === n._h;
          ...
          this._inFlightRoute &&
            this.clc &&
            (V ||
              X.events.emit('routeChangeError', I(), this._inFlightRoute, K),
            this.clc(),
            (this.clc = null)),
            (r = (0, w.addBasePath)(
              (0, b.addLocale)(
          ...
          if (!H && this.onlyAHashChange(Q) && !Z) {
            (W.asPath = Q),
              X.events.emit('hashChangeStart', r, K),
            ...
            try {
              ...
              throw (
                ((0, u.default)(e) &&
                  e.cancelled &&
                  X.events.emit('routeChangeError', e, Q, K),
                e)
              );
            }
            return X.events.emit('hashChangeComplete', r, K), !0;
          }
          ...
          H || X.events.emit('routeChangeStart', r, K);
          ...
          try {
            ...
            X.events.emit('beforeHistoryChange', r, K),
              this.changeState(e, t, r, n);
            let v =
              H && !y && !z && !Z && (0, x.compareRouterStates)(_, this.state);
            if (!v) {
              try {
                await this.set(_, o, y);
              } catch (e) {
              ...
              if (o.error)
                throw (
                  (H || X.events.emit('routeChangeError', o.error, Q, K),
                  o.error)
                );
              H || X.events.emit('routeChangeComplete', r, K),
