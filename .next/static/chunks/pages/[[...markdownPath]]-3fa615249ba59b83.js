(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [116],
  {
    ...
    75955: function (e, t, r) {
      ...
      function m(e) {
        let t,
          {content: r, toc: h, meta: f, languages: m} = e,
          y = (0, c.useMemo)(() => JSON.parse(r, d), [r]),
          S = (0, c.useMemo)(() => JSON.parse(h, d), [h]),
          k = (function () {
      ...
      function d(e, t) {
        if (!Array.isArray(t) || '$r' != t[0]) return t;
        {
          let e = t[1],
            r = t[2],
            a = t[3];
          return (
            'wrapper' === e && ((e = c.Fragment), (a = {children: a.children})),
            h.t[e] && (e = h.t[e]),
            e || (console.error('Unknown type: ' + e), (e = c.Fragment)),
            {
